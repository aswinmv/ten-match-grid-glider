...
const Home = () => {
  ...
  return <div className="min-h-screen flex flex-col items-center justify-center relative bg-cover bg-center bg-no-repeat pt-20" style={{
    backgroundImage: 'url("/lovable-uploads/f5f9751f-528c-408e-bbb7-a9a15528d493.png")'
      ...
      <div className="relative z-10 text-center px-4 mt-16 mx-[5px] my-[212px]">
        ...
        {/* Start Game Button */}
        <Button onClick={handleStartGame} size="lg" className="text-xl px-8 py-4 bg-yellow-400 hover:bg-yellow-300 text-blue-900 font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 border-4 border-yellow-500">
          🎮 START GAME
        </Button>
      </div>
    </div>;
